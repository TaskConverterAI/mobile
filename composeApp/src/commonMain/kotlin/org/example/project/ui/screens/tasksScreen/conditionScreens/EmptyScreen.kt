...
fun EmptyScreen() {
    Column(
        ...
        AsyncImage(
            model = Res.getUri("files/tasks/emptyScreen/Illustration.svg"),
        ...
        Text("Можешь генерировать задачи из заметок автоматически либо создавать их вручную",
        ...
        AsyncImage(
            model = Res.getUri("files/tasks/emptyScreen/Arrow.svg"),
